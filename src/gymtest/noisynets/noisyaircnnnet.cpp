...
NoisyAirCnnNet::NoisyAirCnnNet(const int outputNum):
...
//	fc3(512, outputNum)
//	fc3(1568, 18)
	fc2(std::make_shared<NoisyLinear>(3136, 512)),
	fc3(std::make_shared<NoisyLinear>(512, outputNum))
{
...
torch::Tensor NoisyAirCnnNet::forward(torch::Tensor input) {
...
void NoisyAirCnnNet::resetNoise() {
	fc2->resetNoise();
	fc3->resetNoise();
}

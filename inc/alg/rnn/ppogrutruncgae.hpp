...
#ifndef INC_ALG_RNN_PPOGRUTRUNCGAE_HPP_
#define INC_ALG_RNN_PPOGRUTRUNCGAE_HPP_
...
private:
	...
	log4cxx::LoggerPtr logger = log4cxx::Logger::getLogger("PPOGRUTruncGae");
...
public:
	PPOGRUTruncGae(NetType& behaviorModel, EnvType& iEnv, EnvType& tEnv, PolicyType& iPolicy, OptimizerType& iOptimizer, DqnOption option);
	~PPOGRUTruncGae() = default;
	PPOGRUTruncGae(const PPOGRUTruncGae& ) = delete;
...
template<typename NetType, typename EnvType, typename PolicyType, typename OptimizerType>
PPOGRUTruncGae<NetType, EnvType, PolicyType, OptimizerType>::PPOGRUTruncGae(NetType& behaviorModel, EnvType& iEnv, EnvType& tEnv, PolicyType& iPolicy, OptimizerType& iOptimizer,
...
template<typename NetType, typename EnvType, typename PolicyType, typename OptimizerType>
void PPOGRUTruncGae<NetType, EnvType, PolicyType, OptimizerType>::test() {
	tester.testACNext();
}


template<typename NetType, typename EnvType, typename PolicyType, typename OptimizerType>
void PPOGRUTruncGae<NetType, EnvType, PolicyType, OptimizerType>::train(const int epNum) {
...
template<typename NetType, typename EnvType, typename PolicyType, typename OptimizerType>
void PPOGRUTruncGae<NetType, EnvType, PolicyType, OptimizerType>::save() {
...
template<typename NetType, typename EnvType, typename PolicyType, typename OptimizerType>
void PPOGRUTruncGae<NetType, EnvType, PolicyType, OptimizerType>::saveByReward(float reward) {
	if (!dqnOption.saveModel) {
		return;
	}
...
template<typename NetType, typename EnvType, typename PolicyType, typename OptimizerType>
void PPOGRUTruncGae<NetType, EnvType, PolicyType, OptimizerType>::load() {
...
#endif /* INC_ALG_RNN_PPOGRUTRUNCGAE_HPP_ */

...
public:
	...
	A3CNStep(NetType& behaviorModel, EnvType& iEnv, EnvType& tEnv, PolicyType& iPolicy, int stepSize, DqnOption option, std::shared_ptr<A3CTCPClientHandle<NetType>> iClient);
	~A3CNStep() = default;
